...
public class ID3Model {
    ...
    public TreeNode createDecisionTree(List<List<String>> dataSet) {
        ...
        LOGGER.info("optimal feature is [{}], information gain value is [{}].", optimalAttributeName, maxIG);
     ...
     * @param rootNode 特征结点
     */
    private void setTreeNodeStatus(List<List<String>> dataSet, TreeNode rootNode) {
        // 获取某特征下的所有特征值
     ...
     * @param node                   特征结点
     */
    private void buildDecisionTree(String attributeValue, List<List<String>> splitAttributeDataList, TreeNode node) {
     ...
     * @return
     */
    private TreeNode getNewAttributeNode(String attributeName, String attributeValue, TreeNode node) {
     ...
     * @param rootNode    特征结点
     */
    private void setAttributeNodeStatus(List<List<String>> currentData, TreeNode rootNode) {
