package com.bubble.bnlp.classify.decisionTree.cart.utils;

import com.bubble.bnlp.classify.decisionTree.cart.model.AttributeNode;
...
public class DecisionTreeUtils {
     ...
     * 读取训练数据
     */
    public static List<List<String>> getTrainingData(String fileName) throws IOException {
        List<List<String>> result = new ArrayList<>();
        List<String> fileAllLines = Files.readAllLines(Paths.get(fileName),
