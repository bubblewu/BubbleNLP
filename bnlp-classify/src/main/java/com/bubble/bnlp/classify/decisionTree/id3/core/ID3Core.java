package com.bubble.bnlp.classify.decisionTree.id3.core;


import com.bubble.bnlp.classify.decisionTree.id3.utils.CommonUtils;
...
public class ID3Core {
    ...
    public Map<String, Double> maxInformationGain(List<List<String>> currentData) {
        ...
        for (String attributeName : attributeNames) {
            ...
            System.out.println("current ig value= " +  currentIG);
