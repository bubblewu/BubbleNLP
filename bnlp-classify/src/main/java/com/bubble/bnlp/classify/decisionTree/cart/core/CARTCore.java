package com.bubble.bnlp.classify.decisionTree.cart.core;

import com.bubble.bnlp.classify.decisionTree.cart.model.ContinuouslyVariableUnit;
import com.bubble.bnlp.classify.decisionTree.cart.model.MinContinuouslyGINITuple;
import com.bubble.bnlp.classify.decisionTree.cart.model.MinGINITuple;
import com.bubble.bnlp.classify.decisionTree.cart.utils.CARTUtils;
import com.bubble.bnlp.classify.decisionTree.cart.utils.ContinuouslyVariableUnitComparatorByValue;
...
public class CARTCore {
    ...
    private Map<String, Double> currentAttributeMinGini(Map<String, Map<String, Integer>> attributeMap) {
        ...
        if (NumberUtils.isDigits(keySet.iterator().next())) {
